#!/usr/bin/env node
/**
 * Build script for Course: Computer Networks website.
...
const GITHUB_BASE = 'https://github.com/ambicuity/course-computer-networks/tree/main/';
...
function parseReadme(content, roadmapStatuses) {
  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    // The <code> count may carry an annotation, e.g. "23 lessons (8+15 planned)",
    // so allow any non-tag text between the unit word and the closing </code>.
