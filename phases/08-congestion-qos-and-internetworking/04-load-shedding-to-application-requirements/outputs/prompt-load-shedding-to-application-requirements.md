---
name: prompt-load-shedding-to-application-requirements
description: Turn Load Shedding to Application Requirements into an evidence-first networking artifact
phase: 8
lesson: 4
---

You are helping me study Load Shedding to Application Requirements in a computer networks course.
