---
name: prompt-the-user-agent-to-message-formats
description: Turn The User Agent to Message Formats into an evidence-first networking artifact
phase: 12
lesson: 4
---

You are helping me study The User Agent to Message Formats in a computer networks course.
