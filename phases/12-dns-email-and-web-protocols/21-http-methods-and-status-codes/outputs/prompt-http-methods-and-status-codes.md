---
name: prompt-http-methods-and-status-codes
description: Turn HTTP Request Methods and Status Code Groups into an evidence-first networking artifact
phase: 12
lesson: 21
---

You are helping me study HTTP Request Methods and Status Code Groups in a computer networks course.
