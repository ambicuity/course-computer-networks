---
name: prompt-cgi-server-side-and-client-side-web-apps
description: Turn CGI, Server-Side, and Client-Side Web Apps into an evidence-first networking artifact
phase: 12
lesson: 25
---

You are helping me study CGI, Server-Side, and Client-Side Web Apps in a computer networks course.
