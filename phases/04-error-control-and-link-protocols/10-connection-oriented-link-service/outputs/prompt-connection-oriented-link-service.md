---
name: prompt-connection-oriented-link-service
description: Turn Connection-oriented data link service and its three phases into an evidence-first networking artifact
phase: 4
lesson: 10
---

You are helping me study Connection-oriented data link service and its three phases in a computer networks course.
