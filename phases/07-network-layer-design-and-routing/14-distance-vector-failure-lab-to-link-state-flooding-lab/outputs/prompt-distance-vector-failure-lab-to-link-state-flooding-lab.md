---
name: prompt-distance-vector-failure-lab-to-link-state-flooding-lab
description: Turn Distance Vector Failure Lab to Link State Flooding Lab into an evidence-first networking artifact
phase: 7
lesson: 14
---

You are helping me study Distance Vector Failure Lab to Link State Flooding Lab in a computer networks course.
