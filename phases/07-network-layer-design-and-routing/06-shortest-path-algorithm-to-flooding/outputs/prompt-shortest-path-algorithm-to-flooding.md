---
name: prompt-shortest-path-algorithm-to-flooding
description: Turn Shortest Path Algorithm to Flooding into an evidence-first networking artifact
phase: 7
lesson: 6
---

You are helping me study Shortest Path Algorithm to Flooding in a computer networks course.
