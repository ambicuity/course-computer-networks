---
name: prompt-link-state-routing
description: Turn Link State Routing into an evidence-first networking artifact
phase: 7
lesson: 8
---

You are helping me study Link State Routing in a computer networks course.
