---
name: prompt-dns-works-but-http-fails
description: Turn DNS Works but HTTP Fails into an evidence-first networking artifact
phase: 17
lesson: 2
---

You are helping me study DNS Works but HTTP Fails in a computer networks course.
