---
name: prompt-rogue-dhcp-server-starvation
description: Turn Rogue DHCP Server and DHCP Starvation into an evidence-first networking artifact
phase: 17
lesson: 13
---

You are helping me study Rogue DHCP Server and DHCP Starvation in a computer networks course.
