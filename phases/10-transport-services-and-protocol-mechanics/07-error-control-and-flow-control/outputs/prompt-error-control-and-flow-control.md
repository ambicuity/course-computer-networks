---
name: prompt-error-control-and-flow-control
description: Turn Error Control and Flow Control into an evidence-first networking artifact
phase: 10
lesson: 7
---

You are helping me study Error Control and Flow Control in a computer networks course.
