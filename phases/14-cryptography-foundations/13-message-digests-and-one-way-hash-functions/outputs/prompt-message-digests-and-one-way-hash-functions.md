---
name: prompt-message-digests-and-one-way-hash-functions
description: Turn Message digests and one-way hash functions into an evidence-first networking artifact
phase: 14
lesson: 13
---

You are helping me study Message digests and one-way hash functions in a computer networks course.
