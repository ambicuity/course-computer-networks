---
name: prompt-netflow-ipfix-export-and-flow-based-traffic-accounting
description: Turn NetFlow/IPFIX export and flow-based traffic accounting into an evidence-first networking artifact
phase: 18
lesson: 22
---

You are helping me study NetFlow/IPFIX export and flow-based traffic accounting in a computer networks course.
