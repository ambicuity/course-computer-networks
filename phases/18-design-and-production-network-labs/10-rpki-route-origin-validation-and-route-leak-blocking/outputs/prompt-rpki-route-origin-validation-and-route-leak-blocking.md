---
name: prompt-rpki-route-origin-validation-and-route-leak-blocking
description: Turn RPKI Route Origin Validation and Route-Leak Blocking in Production into an evidence-first networking artifact
phase: 18
lesson: 10
---

You are helping me study RPKI Route Origin Validation and Route-Leak Blocking in Production in a computer networks course.
