---
name: prompt-socket-service-primitives-and-client-server-protocol
description: Turn Service Primitives and the Berkeley Socket Client-Server Protocol into an evidence-first networking artifact
phase: 1
lesson: 17
---

You are helping me study Service Primitives and the Berkeley Socket Client-Server Protocol in a computer networks course.
