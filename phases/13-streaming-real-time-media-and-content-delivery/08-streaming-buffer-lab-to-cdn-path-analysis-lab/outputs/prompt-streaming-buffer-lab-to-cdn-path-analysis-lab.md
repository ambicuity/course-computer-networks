---
name: prompt-streaming-buffer-lab-to-cdn-path-analysis-lab
description: Turn Streaming Buffer Lab to CDN Path Analysis Lab into an evidence-first networking artifact
phase: 13
lesson: 8
---

You are helping me study Streaming Buffer Lab to CDN Path Analysis Lab in a computer networks course.
