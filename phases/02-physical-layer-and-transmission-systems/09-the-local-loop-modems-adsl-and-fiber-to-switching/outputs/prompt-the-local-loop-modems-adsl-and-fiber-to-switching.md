---
name: prompt-the-local-loop-modems-adsl-and-fiber-to-switching
description: Turn The Local Loop Modems, ADSL, and Fiber to Switching into an evidence-first networking artifact
phase: 2
lesson: 9
---

You are helping me study The Local Loop Modems, ADSL, and Fiber to Switching in a computer networks course.
