---
name: prompt-ppp-over-sonet
description: Turn PPP Framing and LCP over SONET into an evidence-first networking artifact
phase: 3
lesson: 13
---

You are helping me study PPP Framing and LCP over SONET in a computer networks course.
