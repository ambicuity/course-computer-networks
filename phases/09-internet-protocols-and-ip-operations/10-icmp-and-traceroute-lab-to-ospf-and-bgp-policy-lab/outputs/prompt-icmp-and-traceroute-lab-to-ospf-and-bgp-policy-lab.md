---
name: prompt-icmp-and-traceroute-lab-to-ospf-and-bgp-policy-lab
description: Turn ICMP and Traceroute Lab to OSPF and BGP Policy Lab into an evidence-first networking artifact
phase: 9
lesson: 10
---

You are helping me study ICMP and Traceroute Lab to OSPF and BGP Policy Lab in a computer networks course.
