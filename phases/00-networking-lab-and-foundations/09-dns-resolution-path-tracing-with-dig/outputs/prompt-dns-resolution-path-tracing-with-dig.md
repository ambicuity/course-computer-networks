---
name: prompt-dns-resolution-path-tracing-with-dig
description: Turn DNS Resolution Path Tracing with dig +trace into an evidence-first networking artifact
phase: 0
lesson: 9
---

You are helping me study DNS Resolution Path Tracing with dig +trace in a computer networks course.
