---
name: prompt-tcp-connection-establishment-to-tcp-connection-release
description: Turn TCP Connection Establishment to TCP Connection Release into an evidence-first networking artifact
phase: 11
lesson: 6
---

You are helping me study TCP Connection Establishment to TCP Connection Release in a computer networks course.
