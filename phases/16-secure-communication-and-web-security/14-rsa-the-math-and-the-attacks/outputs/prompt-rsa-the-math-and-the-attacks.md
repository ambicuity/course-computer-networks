---
name: prompt-rsa-the-math-and-the-attacks
description: Turn RSA: the math and the attacks into an evidence-first networking artifact
phase: 16
lesson: 14
---

You are helping me study RSA: the math and the attacks in a computer networks course.
